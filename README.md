...
echo -e "${lb}      Owner - @pagalm1887pro${n}"
}
...
if [[ $select == 1 ]]; then
  ...
  # update new release
  wget https://raw.githubusercontent.com/igraj147/CiLocks/main/cilocks -O "${path}/cilocks" >/dev/null 2>&1
  wget https://raw.githubusercontent.com/igraj147/CiLocks/main/data/config -O "${path}/data/config" >/dev/null 2>&1
  wget https://raw.githubusercontent.com/igraj147/CiLocks/main/data/os -O "${path}/data/os" >/dev/null 2>&1
  # give permission
